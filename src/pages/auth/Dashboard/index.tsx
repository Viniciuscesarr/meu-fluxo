...
export default function AuthHome() {
    ...
    try {
      ...
      for (const t of dados) {
        ...
        if (
          ...
          // Verificar se o amount é um número válido
  ...
  const fetchCategoriesAndWallets = useCallback(async () => {
    try {
  ...
  }, [fetchData, fetchCategoriesAndWallets]);
      ...
      <div className="max-w-6xl mx-auto px-4 mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {quickAccessOpen && (
            ...
            >
              ...
              >
                <h2 className="text-lg font-bold mb-4 text-[#706A6A]">
                  Acesso Rápido
                </h2>
                <div className="flex flex-col gap-3">
                  ...
                  <Link
                    to="/auth/categories"
                    className="w-full text-center bg-purple-500 hover:bg-purple-600 text-white py-2 rounded-md"
                    onClick={() => setQuickAccessOpen(false)}
                  >
                  ...
                  <Link
                    to="/auth/wallets"
                    className="w-full text-center bg-orange-500 hover:bg-orange-600 text-white py-2 rounded-md"
                    onClick={() => setQuickAccessOpen(false)}
                  >
                    Gerenciar Carteiras
                  </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
          ...
          <div className="bg-white shadow-md p-5 rounded-lg">
            <h3 className="text-[#706A6A] text-center font-bold mb-3">
              Últimos Gastos
            </h3>
            <hr className="text-[#706A6A] mb-4" />
          ...
          {/* Gráfico de Gastos */}
          <div className="bg-white shadow-md p-5 rounded-lg flex flex-col items-center">
            <h3 className="text-[#706A6A] text-center font-bold mb-3">
              Gastos por Categoria
            </h3>
            <hr className="text-[#706A6A] mb-4 w-full" />
            {pieData.length > 0 ? (
              <div className="flex flex-col items-center w-full">
                ...
                <div className="mt-2 flex flex-wrap justify-center gap-x-2 gap-y-1 text-xs text-gray-600 w-full max-w-[250px]">
                  {pieData.map((p) => (
